...
function projectControls(){
  ...
  $(this).on('mousemove', function (e) {
    ...
    $(this).children('.project:first-of-type').css({'margin-left':newMarginX, 'margin-top':newMarginY})
    })
  })
  ...
  $('.company.condensed').on('mouseleave', function(e){
    let el = $(this)
      ...
      setTimeout(function(){
        ...
        el.children('.project:first-of-type').css({'margin-left':'-50%', 'margin-top':0})
        }
      }, 1000)
  ...
  $(this).off();
  $(this).addClass('expanded').removeClass('condensed').children('.project:first-of-type').css({'margin-left':'0', 'margin-top':0, 'min-height':window.innerHeight})
    ...
    $(this).append('<div class="close">close</div>').on('click', function(){
      ...
      $(this).children('.project:first-of-type').css({'margin-left':'-50%', 'margin-top':0, 'height':'auto', 'min-height':'auto'})
      projectControls();
